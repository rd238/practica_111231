...
\begin{document}
	...
	{\textbf{Блок-схема}\par 
		...
		\begin{tikzpicture}
			\draw (0,0)--(10,0)--(10,-3)--(0,-3)--cycle;
			\draw (0,-1)--(10,-1);
			\draw (0,-2)--(10,-2);
			\draw (7,0)--(7,-3);
			\node at (1.2,-0.5) {\textbf{Ввод}};
			\node at (8,-0.5) {\textbf{Вывод}};
			\node at (2, -1.5) {K[3]=\{5,6,7\}, 3, 8, 2};
			\node at (2, -2.5) {Q[2]=\{7,7\}, 2, 8, 10};
			\node at (8.5, -1.5) {101110111};
			\node at (8, -2.5) {63};
		\end{tikzpicture}}
		...
		\begin{tikzpicture}
			\draw (0,0)--(10,0)--(10,-2.5)--(0,-2.5)--cycle;
			\draw (0,-1)--(10,-1);
			\draw (7,0)--(7,-2.5);
			\node at (1.2,-0.5) {\textbf{Ввод}};
			\node at (8,-0.5) {\textbf{Вывод}};
			\node at (2.3, -1.5) {points = \{\{3,1\}, \{5,2\},};
			\node at (2, -2) {\{2,5\},\{1,1\}\}, 4};
			\node at (8.5, -1.5) {8.500000};
		\end{tikzpicture}}
		...
		\begin{center}
			\begin{tikzpicture}
				...
				\node at (0, 0) {Начало};
				\draw [->] (0,-0.5)--(0,-1);
				\draw (-2.5,-1)--(3,-1)--(2.5,-2)--(-3,-2)--cycle;
				\node at (0,-1.5) {Ввод A(m,n), res(), m, n};
				\draw [->] (0,-2)--(0,-2.5);
				\draw (-2,-2.5)--(2,-2.5)--(2,-3.5)--(-2,-3.5)--cycle;
				\node at (0,-3) {size\_res:=0};
				\draw [->] (0,-3.5)--(0,-4);
				\draw (-1,-4)--(1,-4)--(1.5,-4.5)--(1,-5)--(-1,-5)--(-1.5,-4.5)--cycle;
				\node at (0, -4.5) {i:=0...m};
				\draw [-<](0,-5)--(0,-5.5);
				\draw (-1,-5.5)--(1,-5.5)--(1.5,-6)--(1,-6.5)--(-1,-6.5)--(-1.5,-6)--cycle;
				\node at (0, -6) {j:=i+1...n};
				\draw [->] (0,-6.5)--(0,-7);
				\draw (-1.5,-7)--(1.5,-7)--(1.5,-9)--(-1.5,-9)--cycle;
				\node at (0,-7.5) {temp:=$A_{i,j}$};
				\node at (0,-8) {$A_{i,j}:=A_{j,i}$};
				\node at (0,-8.5) {$A_{j,i}$:=temp};
				\draw [->] (0, -9)--(0,-9.5)--(-2,-9.5)--(-2,-6)--(-1.5,-6);
				\draw [->] (1.5,-6)--(2,-6)--(2,-10)--(-2.5,-10)--(-2.5,-4.5)--(-1.5,-4.5);
				\draw [->] (1.5,-4.5)--(2.5,-4.5)--(2.5,-10.5)--(0,-10.5)--(0,-11);
				\draw (-1,-11)--(1,-11)--(1.5,-11.5)--(1,-12)--(-1,-12)--(-1.5,-11.5)--cycle;
				\node at (0, -11.5) {i:=0...m};
				\draw [->](0,-12)--(0,-12.5);
				\draw (-1,-12.5)--(1,-12.5)--(1.5,-13)--(1,-13.5)--(-1,-13.5)--(-1.5,-13)--cycle;
				\node at (0, -13) {j:=0...n};
				\draw [->] (0,-13.5)--(0,-14);
				\draw (-2,-14)--(2,-14)--(2,-15.5)--(-2,-15.5)--cycle;
				\node at (0,-14.5) {$res_{size\_res}:=A_{i,j}$};
				\node at (0,-15) {size\_res:=size\_res+1};
				\draw [->] (0,-15.5)--(0,-16)--(-2.5,-16)--(-2.5,-13)--(-1.5,-13);
				\draw [->] (1.5,-13)--(2.5,-13)--(2.5,-16.5)--(-3,-16.5)--(-3,-11.5)--(-1.5,-11.5);
				\draw [->] (1.5,-11.5)--(3,-11.5)--(3,-17)--(0,-17)--(0,-17.5);
				\draw (-2,-17.5)--(2.5,-17.5)--(2,-18.5)--(-2.5,-18.5)--cycle;
				\node at (0,-18) {Вывод size\_res};
				\draw [->](0,-18.5)--(0,-19);
				\filldraw [fill=black!5, very thick] (0,-19.5) ellipse (1.5 and 0.5);
				\node at (0, -19.5) {Конец};
			\end{tikzpicture}\par
		\end{center}}
		...
		\begin{tikzpicture}
			...
			\node at (1.2,-0.5) {\textbf{Ввод}};
			\node at (8,-0.5) {\textbf{Вывод}};
			\node at (3, -1.5) {A=\{\{0,0\},\{1,1\},\{2,2\}\}, T, 3, 2};
			\node at (3, -2.5) {A=\{\{0,1\},\{2,3\},\{4,5\}\}, T, 3, 2};
			\node at (8.5, -1.5) {T=\{0,1,0,1,2,2\}};
			\node at (8.5, -2.5) {T=\{0,2,1,3,4,5\}};
		\end{tikzpicture}}
		...
		\begin{center}
			\begin{tikzpicture}
				...
				\node at (0, 0) {Начало};
				\draw [->] (0,-0.5)--(0,-1);
				\draw (-1.5,-1)--(2,-1)--(1.5,-2)--(-2,-2)--cycle;
				\node at (0,-1.5) {Ввод text};
				\draw [->] (0,-2)--(0,-2.5);
				\draw (-2,-2.5)--(2,-2.5)--(2,-4)--(-2,-4)--cycle;
				\node at (0,-3) {str\_size:=60};
				\node at (0,-3.5) {counter:=0};
				\draw [->] (0,-4)--(0,-4.5);
				\draw (-2.5,-4.5)--(2.5,-4.5)--(3,-5)--(2.5,-5.5)--(-2.5,-5.5)--(-3,-5)--cycle;
				\node at (0,-5) {$i:=text_i,i\neq$'\textbackslash 0'};
				\draw [->] (0,-5.5)--(0,-6);
				\draw (0,-6)--(2,-7)--(0,-8)--(-2,-7)--cycle;
				\node at (0,-7) {counter=str\_size};
				\node at (0.2,-5.8){+};
				\node at (2,-6.5){+};
				\draw [->] (2,-7)--(3,-7)--(3,-8);
				\draw (2,-8)--(4,-8)--(4.5,-9)--(2.5,-9)--cycle;
				\node at (3,-8.5) {\textbackslash n};
				\draw [->] (3,-9)--(3,-9.5);
				\draw (2,-9.5)--(4,-9.5)--(4,-10.5)--(2,-10.5)--cycle;
				\node at (3,-10) {counter:=0};
				\draw (3,-10.5)--(3,-11)--(-3,-11)--(-3,-7)--(-2,-7);
				\draw [->] (0,-22)--(0,-22.5)--(-3.5,-22.5)--(-3.5,-5)--(-3,-5);
				\draw [->] (3,-5)--(5,-5)--(5,-12)--(5,-23)--(0,-23)--(0,-23.5);
				\draw (0,-12.5)--(1,-13.5)--(0,-14.5)--(-1,-13.5)--cycle;
				\node at (0,-13.5) {i='\$'};
				\draw [->](0,-11)--(0,-12.5);
				\node at (1,-13){+};
				\draw [->] (1,-13.5)--(1.5,-13.5)--(1.5,-14.5);
				\draw (0.5,-14.5)--(2.5,-14.5)--(2.5,-15.5)--(0.5,-15.5)--cycle;
				\node at (1.5,-15) {i:='\textbackslash n'};
				\draw [->] (1.5,-15.5)--(1.5,-16);
				\draw (0,-16)--(3,-16)--(2.5,-17)--(-0.5,-17)--cycle;
				\node at (1.5, -16.5) {i,'\textbackslash n'};
				\draw [->] (1.5,-17)--(1.5,-17.5);
				\draw (0,-17.5)--(3,-17.5)--(3,-18.5)--(0,-18.5)--cycle;
				\node at (1.5,-18) {counter:=0};
				\draw (1.5,-18.5)--(1.5,-19)--(-1.5,-19)--(-1.5,-13.5)--(-1,-13.5);
				\draw [->](0,-19)--(0,-19.5);
				\draw (-1.5,-19.5)--(2.5,-19.5)--(2,-20.5)--(-2,-20.5)--cycle;
				\node at (0,-20){i};
				\draw [->] (0,-20.5)--(0,-21);
				\draw (-2,-21)--(2,-21)--(2,-22)--(-2,-22)--cycle;
				\node at (0, -21.5) {counter:=counter+1};
				\filldraw [fill=black!5, very thick](0,-24) ellipse (1.5 and 0.5);
				\node at (0, -24) {Конец};
			\end{tikzpicture}\par
		\end{center}}
		...
		\begin{tikzpicture}
			...
			\node at (1.2,-0.5) {\textbf{Ввод}};
			\node at (8,-0.5) {\textbf{Вывод}};
			\node at (2, -1.5) {Большой текст};
			\node at (2, -2.5) {Длинный текст};
			\node at (8, -1.5) {поделенный текст};
			\node at (8, -2.5) {поделенный текст};
		\end{tikzpicture}}
		...
		\begin{flushleft}
			\begin{tikzpicture}
				...
				\begin{axis}[
					...
					\addplot3 [surf, color=red, mark=none, fill=red!50] {2};
					\addplot3 [color=black, mark=*] coordinates {(0,0,2)};
				\end{axis}
			\end{tikzpicture}
		\end{flushleft}
		...
		\begin{flushleft}
			\newpage
			{\textbf{Задание 15}}\par
			{\textbf{Tема 15. Поверхность второго порядка в трехмерном пространстве}}\par
			{Построить верхнюю часть эллипсоида, заданного уравнением 
			$\frac{x^2}{9}+\frac{y^2}{4}+z^2=1$, лежащую в диапазоне $-3\leq x\leq 3$, $-2\leq y\leq 2$ с 
			шагом $\Delta =0.5$ для обеих переменных.} \par
		\end{flushleft}
		...
		\begin{flushleft}
			\begin{tikzpicture}
				\begin{axis}[
					...
					\addplot3 [surf, color=blue, fill=red!30] {(x^2/9)+(y^2/4)-1};%+(z^2)-1 вместо -1 в конце
	...
	\end{center}
	\begin{flushleft}
		Вывод: закрепил темы, пройденные на занятиях по Основам программирования,
		научился работать с системой компьютерной верстки \LaTeX и
		пакетом TiKZ для создания графики(2D и 3D).
	\end{flushleft}
